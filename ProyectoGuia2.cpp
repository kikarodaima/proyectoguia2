...
struct variosProductos {
    int numProd ;             // productos por vendedor
...
struct Vendedor lista[MAX_V]; // creamos un array de vendedores
struct Vendedor aux;
...
{
    int np ;  //  productos por cada vendedor
    for(int i=0; i<n; i++)
    {
        cout<<"\nVENDEDOR "<< i+1 << "\n";
...
int main()
{
    int num=0;  // numero de vendedores
